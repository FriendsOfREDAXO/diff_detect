(function (global, factory) {
    ...
    var BACKSPACE = 8, TAB = 9, ENTER = 13, LEFT = 37, RIGHT = 39, DELETE = 46, COMMA = 188;
    var SEPERATOR = ',';
    ...
    function tagsInput(input) {
        ...
        function setInputWidth() {
            var last = $('.tag', true).pop(), w = base.offsetWidth;
            if (!w) return;
        ...
        if (input.nextElementSibling && input.nextElementSibling.classList.contains('tags-input')) {
            return;
        }

        var base = createElement('div', 'tags-input form-control'), sib = input.nextSibling;
        ...
        base.input.setAttribute('list', input.getAttribute('list'));
        ...
        base.input.addEventListener('keydown', function (e) {
            var el = base.input, key = e.keyCode || e.which, selectedTag = $('.tag.selected'),
                pos = el.selectionStart === el.selectionEnd && el.selectionStart, last = $('.tag', true).pop();
            setInputWidth();
